...
$(function() {
    ...
    $('input[name="dpt"]').on('click', function() {
        if ($('input[name="dpt"]').is(':checked')) {
            ...
            //style
            $('.dpt-column .search-item').css({
                "border": "1px solid #dadada",
                "box-shadow": "0 1px 3px 0 rgba(0, 0, 0, 0.10), 0 2px 4px 0 rgba(0, 0, 0, 0.02)",
                "background-color": "#ffffff"
            });
            $(this).parent().css({
                "border": "2px solid #1BA0E2",
                "box-shadow": "0 1px 2px 0 rgba(0, 0, 0, 0.10), 0 1px 4px 0 rgba(0, 0, 0, 0.02)",
        ...
        totalPriceAllPassengers = totalPrice * 1; //sesuai jumlah passengers
    ...
    $('input[name="rtn"]').on('click', function() {
        ...
        totalPrice = (Number(dptPrice) + Number(rtnPrice)) * 1;
        $("#totalprice").html(totalPrice);
